...
var tracker = new function () {
  ...
  function createUserCookie(_this) {
    ...
    if (!cookieValue || cookieValue === '') {
      ...
      document.cookie = USER_COOKIE + '=' + _this.userCookie + ';max-age=' + 60*60*24*365;
    }
  }
  ...
  function createSessionCookie(_this) {
    ...
    if (!cookieValue || cookieValue === '') {
      ...
      document.cookie = SESSION_COOKIE + '=' + _this.sessionCookie;
    }
  }
  ...
  function replaceActionCookie(newCookie, _this) {
    ...
    document.cookie = ACTION_COOKIE + '=' + _this.actionCookie
  }
  ...
  function loadPixel(pixelData, _this) {
    ...
    pixel.setAttribute('src', 'http://10.0.2.2:3000/track/pixel?' + params.join('&'));
